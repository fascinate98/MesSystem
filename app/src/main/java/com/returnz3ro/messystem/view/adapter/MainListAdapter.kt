...
//
//
//class MainListAdapter(joborderList: List<Joborder>, context: Context) : RecyclerView.Adapter<MainListAdapter.ListViewHolder>() {
//
//    private val originalBg: Int by bindColor(context, R.color.zlightblue)
...
//    //private val filteredItems = intArrayOf(2)
//    //private val modelListFiltered = joborderList.filter { it.joborderStatus !in filteredItems }
//    private val adapterList = joborderList
//
...
//        Log.d(ContentValues.TAG, model.joborderJobname + " 123 이이이잉")
//        expandItem(holder, model == expandedModel, animate = false)
//        scaleDownItem(holder, position, isScaledDown)
//
//        holder.jobname.setText(model.joborderJobname)
//
...
//    ///////////////////////////////////////////////////////////////////////////
//
//    class ListViewHolder(val binding: Bining) : RecyclerView.ViewHolder(binding.root) {
...
//        val jobname : TextView by bindView(R.id.joborder_jobname)
//        val materialProbId : View by bindView(R.id.material_prob_id)
//        val materialLotno : View by bindView(R.id.material_lotno)
//    }
//}